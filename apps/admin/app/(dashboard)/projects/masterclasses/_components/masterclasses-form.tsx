...
import {
  createMasterclassesContent,
  updateMasterclassesContent,
} from '../_actions/masterclasses.actions';
export function MasterclassesForm({
  initialValues,
  masterclassId,
}: {
  initialValues: CreateMasterclassesContentDto;
  ...
  const form = useForm<
    z.input<typeof createMasterclassesContentDtoSchema>,
    undefined,
    CreateMasterclassesContentDto
  >({
    resolver: zodResolver(createMasterclassesContentDtoSchema),
    ...
    <form className="space-y-6" onSubmit={onSubmit}>
            ...
            {fields.map((translation, index) => (
              <TabsContent key={translation.id} value={translation.locale}>
                ...
                <FieldGroup>
                  <Field>
                    <FieldLabel
                      htmlFor={`masterclass-title-${translation.locale}`}
                    >
                      Название
                    </FieldLabel>
                    <Input
                      ...
                      id={`masterclass-title-${translation.locale}`}
                  ...
                  <Field>
                    ...
                    <Textarea
                      ...
                      id={`masterclass-text-${translation.locale}`}
      ...
      <div className="flex justify-end gap-3">
        <Button asChild disabled={isSubmitting || uploading} variant="outline">
          <Link href="/projects/masterclasses">Отменить</Link>
        </Button>
