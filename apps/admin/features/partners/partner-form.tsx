      ...
      <Card>
        ...
        <CardContent><FieldGroup>
          ...
          <Field data-invalid={Boolean(form.formState.errors.websiteUrl)}>
            ...
            />
            <FieldDescription>Ссылка на официальный сайт партнёра.</FieldDescription>
          ...
          <Field data-invalid={Boolean(form.formState.errors.sortOrder)}>
            <FieldLabel htmlFor="partner-sort-order">Порядок отображения</FieldLabel>
            <Input
            ...
            render={({ field, fieldState }) => (
              ...
              >
                <div className="space-y-1">
                  <FieldLabel htmlFor="partner-active">Показывать на сайте</FieldLabel>
                  <FieldDescription>
    ...
    <TabsContent value={locale}><FieldGroup>
      <Field data-invalid={Boolean(errors?.name)}>
        <FieldLabel htmlFor={`${locale}-partner-name`}>
          {locale === 'ru' ? 'Название' : 'Name'}{required ? ' *' : ''}
        </FieldLabel>
        <Input
