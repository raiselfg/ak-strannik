        ...
        <Table>
          ...
          <TableBody>
            {projects.map((project) => {
              const ru = project.translations.find(
                (item) => item.locale === 'ru'
              );
              ...
              return (
                <TableRow key={project.id}>
                  <TableCell>
                    {project.coverImage ? (
                      <MediaPreview
                        ...
                        url={project.coverImage.publicUrl}
                      />
                    ) : (
                  ...
                  <TableCell>
                    ...
                    >
                      {getContentStatusLabel(project.status)}
                    </Badge>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    Секций: {project._count.sections}
                    <br />
                    Мероприятий: {project._count.events}
                  </TableCell>
                  ...
                  <TableCell>
                    <div className="flex justify-end gap-2">
                      ...
                      <DeleteDialog
                        ...
                        description={`Проект, его переводы и все вложенные секции будут удалены. Связанные мероприятия сохранятся без проекта. Изображения останутся в медиатеке.${project._count.sections ? ` Секций: ${project._count.sections}.` : ''}`}
