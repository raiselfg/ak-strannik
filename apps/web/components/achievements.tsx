...
export default function Achievements() {
  return (
    <section>
      <div className="container mx-auto flex flex-col items-center justify-center gap-16 px-2 md:gap-24">
