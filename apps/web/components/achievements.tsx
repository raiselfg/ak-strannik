  ...
  return (
    <section>
      <div className="container mx-auto flex flex-col items-center justify-center gap-16 px-4 md:gap-24">
        <h2 className="text-foreground text-center font-sans text-5xl font-bold tracking-tight md:text-7xl">
          Наши достижения
        </h2>

        <div className="grid w-full max-w-6xl grid-cols-1 gap-6 sm:grid-cols-3 lg:gap-8">
          {stats.map((s, i) => (
            <div
              key={s.label}
              className="flex flex-col transition-transform duration-500"
            >
              <div className="group relative flex h-full min-h-[280px] flex-col justify-center overflow-hidden rounded-[24px] border border-white/10 bg-[#0A0D1A]/60 p-8 text-left backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:border-white/20 hover:bg-[#0A0D1A]/80 hover:shadow-[0_20px_40px_rgba(200,165,100,0.1)]">
